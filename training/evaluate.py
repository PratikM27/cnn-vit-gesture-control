...
==========================================
Evaluates trained models on the test set and generates
comprehensive metrics, confusion matrices, and reports.
...
from config import (
    CNN_CONFIG, VIT_CONFIG, PATHS, TRAINING,
...
def main():
    ...
    if not os.path.exists(checkpoint_path):
        ...
        print("Train the model first with: python training/train.py --model " + model_type)
        return
    ...
    cm_path = os.path.join(PATHS["confusion_matrices"], f"{model_type}_confusion_matrix.png")
    plot_confusion_matrix(
        np.array(results['confusion_matrix']),
        class_names, cm_path, model_type
    )
    
    # Save full results
    save_path = os.path.join(PATHS["results"], f"{model_type}_eval_results.json")
